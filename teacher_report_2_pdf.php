...
if (count($students) > 0) {
    ...
    $pdf->Cell(70, 10, iconv('utf-8', 'cp874', 'จำนวนคาบ'), 1, 0, 'C');
    ...
    foreach ($students as $student) {
        ...
        $pdf->Cell(70, 10, $student['count'], 1, 0, 'C');
        $totalCount += $student['count'];
        // $pdf->Cell(30, 10, iconv('utf-8', 'cp874', $student['cause'] . '  ' . $student['custom_cause']), 1, 1, 'L');
        $pdf->Cell(100, 10, iconv('utf-8', 'cp874', $student['cause'] . '  ' . $student['custom_cause']), 1, 1, 'L');
        // $pdf->Cell(100, 10, iconv('utf-8', 'cp874', $student['cause']), 1, 1, 'L');
...
$pdf->Cell(20, 10, iconv('utf-8', 'cp874', 'รวม' . ' '), 1, 0, 'R');
$pdf->Cell(70, 10, iconv('utf-8', 'cp874', '' . ' ' . $totalCount), 1, 0, 'C');
$pdf->Cell(100, 10, iconv('utf-8', 'cp874', '' . ' '), 1, 0, 'C');
