...
if (
    ...
    $stmt = $conn->prepare("INSERT INTO ck_students (`tb_student_code`, `tb_student_name`, `tb_student_sname`,`tb_student_degree`)
                            VALUES (:tb_student_code, :tb_student_name, :tb_student_sname, :tb_student_degree)");
