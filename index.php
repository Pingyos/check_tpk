                            ...
                            <form class="user" method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="date" class="form-control form-control-user" id="current_time"
                                            name="current_time">
                                    </div>
                                    <script>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="body">
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period1', this)">
                                            ...
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period2', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                            ...
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period3', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                            ...
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period5', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                            ...
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period6', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                                    ...
                                                    <path
                                                        d="M232.4 84.7c11.4-13.5 9.7-33.7-3.8-45.1s-33.7-9.7-45.1 3.8L38.6 214.7C14.7 242.9 1.1 278.4 .1 315.2c0 1.4-.1 2.9-.1 4.3c0 .2 0 .3 0 .5c0 88.4 71.6 160 160 160s160-71.6 160-160c0-85.5-67.1-155.4-151.5-159.8l63.9-75.6zM256 320A96 96 0 1 1 64 320a96 96 0 1 1 192 0z" />
                                                </svg>
                                            </a>
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period7', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                            ...
                                            <a class="btn btn-success btn-circle btn-lg"
                                                onclick="togglePeriod('period8', this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                                                    viewBox="0 0 320 512">
                                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                    <style>
                                                    ...
                                                    <path
                                                        d="M304 160c0-70.7-57.3-128-128-128H144C73.3 32 16 89.3 16 160c0 34.6 13.7 66 36 89C20.5 272.3 0 309.8 0 352c0 70.7 57.3 128 128 128h64c70.7 0 128-57.3 128-128c0-42.2-20.5-79.7-52-103c22.3-23 36-54.4 36-89zM176.1 288H192c35.3 0 64 28.7 64 64s-28.7 64-64 64H128c-35.3 0-64-28.7-64-64s28.7-64 64-64h15.9c0 0 .1 0 .1 0h32c0 0 .1 0 .1 0zm0-64c0 0 0 0 0 0H144c0 0 0 0 0 0c-35.3 0-64-28.7-64-64c0-35.3 28.7-64 64-64h32c35.3 0 64 28.7 64 64c0 35.3-28.6 64-64 64z" />
                                                </svg>
                                            </a>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-12">
                                        ...
                                        <select name="subject" id="course-select" class="form-control"
                                            onchange="getCourseDetails()">
                                            <option value="">โปรดเลือกวิชา</option>
                                            <?php foreach ($result as $row) : ?>
                                            <option value="<?= $row['tb_course_code'] ?>"><?= $row['tb_course_name'] ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                        ...
                                        if (selectedCourseCode !== '') {
                                            ...
                                            xhttp.onreadystatechange = function() {
                                                if (this.readyState == 4 && this.status == 200) {
                                                    ...
                                                    var courseDetailsDiv = document.getElementById(
                                                        "course-details");
                                                    courseDetailsDiv.innerHTML = courseDetails;
                                                }
                                            };
                                            xhttp.open("GET", "get_course_details.php?course_code=" +
                                                selectedCourseCode, true);
                                            xhttp.send();
                                        } else {
                                    ...
                                    <input type="hidden" name="tb_teacher_id" id="tb_teacher_id"
                                        value="<?php echo $teacher_id; ?>">
                                    <?php $tb_teacher_name = $_GET['tb_teacher_name'];
                                    ?>
                                    <input type="hidden" name="tb_teacher_name" id="tb_teacher_name"
                                        value="<?php echo $tb_teacher_name; ?>">
                                </div>
                                <!--  -->
